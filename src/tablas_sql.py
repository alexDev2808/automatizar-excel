...
agregar_colaborador("SILVIANO FLORES DE LA CRUZ", "ANALISTA MANTENIMIENTO MOLDES")
agregar_colaborador("MIGUEL LEAL HERNANDEZ", "ANALISTA DE SISTEMAS")
agregar_colaborador("ESTEBAN JAVIER HERNANDEZ SANCHEZ", "INGENIERO DE PRODUCTO")
agregar_colaborador("JOSE EDUARDO GARCIA GONZALEZ", "SMED 1")
agregar_colaborador("JOSE EDUARDO GARCIA GONZALEZ", "ANALISTA MANTENIMIENTO MAQUINAS INYECCION")
agregar_colaborador("ALIN  YESENIA BADILLO ESPINOSA ", "DISEÑO GRAFICO")
...
agregar_colaborador_area("INYECCION", "ANALISTA MANTENIMIENTO MOLDES")
agregar_colaborador_area("INYECCION", "ANALISTA MANTENIMIENTO MAQUINAS INYECCION")
agregar_colaborador_area("INGENIERIA E INNOVACION", "AUXILIAR POST-VENTA")
agregar_colaborador_area("INGENIERIA E INNOVACION", "ANALISTA DE SISTEMAS")
agregar_colaborador_area("INGENIERIA E INNOVACION", "INGENIERO DE PRODUCTO")
agregar_colaborador_area("E-COMMERCE", "DISEÑO GRAFICO")
agregar_colaborador_area("INYECCION", "SMED 1")


agregar_colaborador_tpuesto("ADMINISTRATIVO CONFIANZA", "AUXILIAR POST-VENTA")
agregar_colaborador_tpuesto("ADMINISTRATIVO CONFIANZA", "ANALISTA DE SISTEMAS")
agregar_colaborador_tpuesto("ADMINISTRATIVO CONFIANZA", "INGENIERO DE PRODUCTO")
agregar_colaborador_tpuesto("ADMINISTRATIVO CONFIANZA", "DISEÑO GRAFICO")
agregar_colaborador_tpuesto("OPERATIVO", "ENSAMBLADOR")
agregar_colaborador_tpuesto("OPERATIVO", "OPERADOR DE INYECCION")
agregar_colaborador_tpuesto("OPERATIVO", "ANALISTA MANTENIMIENTO MOLDES")
agregar_colaborador_tpuesto("OPERATIVO", "ANALISTA MANTENIMIENTO MAQUINAS INYECCION")
agregar_colaborador_tpuesto("OPERATIVO", "SMED 1")

agregar_colaborador_npuesto("General", "ENSAMBLADOR")
agregar_colaborador_npuesto("General", "OPERADOR DE INYECCION")
agregar_colaborador_npuesto("General", "ANALISTA MANTENIMIENTO MOLDES")
agregar_colaborador_npuesto("General", "ANALISTA MANTENIMIENTO MAQUINAS INYECCION")
agregar_colaborador_npuesto("Administrativo", "AUXILIAR POST-VENTA")
agregar_colaborador_npuesto("Administrativo", "ANALISTA DE SISTEMAS")
agregar_colaborador_npuesto("Administrativo", "INGENIERO DE PRODUCTO")
agregar_colaborador_npuesto("Administrativo", "DISEÑO GRAFICO")
agregar_colaborador_npuesto("General", "SMED 1")
